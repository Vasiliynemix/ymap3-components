...
const YMapComponentsProviderBase: React.FC<YMapComponentsProviderProps> = ({
  ...
  return <YMapsContextState.Provider value={state}>{children}</YMapsContextState.Provider>;
};
const YMapComponentsProvider = React.memo<YMapComponentsProviderProps>(YMapComponentsProviderBase);

function YMapComponentFabric<RefType, ArgsType>(componentName: string, YMapPackage?: Package) {
  let Component: React.FC<ArgsType>;

  // Используем any для forwardRef, чтобы обойти несовместимость типов
  const component = (props: ArgsType, ref: React.Ref<RefType>) => {
    ...
    useIsomorphicEffect(() => {
      if (!YMapPackage) {
        ...
        if ((window as any)[YMapPackage]) {
          setIsLoaded(true);
          Component = reactify.module((window as any)[YMapPackage])[componentName] as React.FC<ArgsType>;
        } else {
          ymaps.import(YMapPackage as any).then((data) => {
            (window as any)[YMapPackage] = data;
            if (reactify.module(data)) {
              setIsLoaded(true);
              Component = reactify.module(data as any)[componentName] as React.FC<ArgsType>;
            }
          });
        }
      }
    ...
    if (!Component || !isLoaded) return null;
    return <Component ref={ref} {...props} />;
  };

  // "Обходная" типизация через any
  const ForwardedRefComponent = React.forwardRef<any, any>(component);

  ForwardedRefComponent.displayName = componentName;

  return ForwardedRefComponent as React.FC<ArgsType & React.RefAttributes<RefType>>;
}
...
export const YMapGeolocationControl = YMapComponentFabric<Controls.YMapGeolocationControl, YMapGeolocationControlProps>(
  "YMapGeolocationControl",
  Package.Controls,
);

export type YMapZoomControlProps = React.ComponentPropsWithoutRef<typeof ControlsReact.YMapZoomControl>;
export const YMapZoomControl = YMapComponentFabric<Controls.YMapZoomControlProps, YMapZoomControlProps>(
  "YMapZoomControl",
  Package.Controls,
);

export type YMapClustererProps = React.ComponentPropsWithoutRef<typeof ClustererReact.YMapClusterer>;
export const YMapClusterer = YMapComponentFabric<Clusterer.YMapClusterer, YMapClustererProps>(
  "YMapClusterer",
  Package.Clusterer,
);

export type YMapDefaultMarkerProps = React.ComponentPropsWithoutRef<typeof MarkersReact.YMapDefaultMarker>;
export const YMapDefaultMarker = YMapComponentFabric<Markers.YMapDefaultMarker, YMapDefaultMarkerProps>(
  "YMapDefaultMarker",
  Package.Markers,
);
...
export const YMapTileDataSource = YMapComponentFabric<YMaps.YMapTileDataSource, YMapTileDataSourceProps>(
  "YMapTileDataSource",
);

export const ThemeContext = YMapComponentFabric<YMaps.YMapThemeContext, typeof YMapsReact.ThemeContext | any>(
  "ThemeContext",
);
...
export const YMapDefaultSchemeLayer = YMapComponentFabric<YMaps.YMapDefaultSchemeLayer, YMapDefaultSchemeLayerProps>(
  "YMapDefaultSchemeLayer",
);

export type YMapDefaultFeaturesLayerProps = React.ComponentPropsWithoutRef<typeof YMapsReact.YMapDefaultFeaturesLayer>;
export const YMapDefaultFeaturesLayer = YMapComponentFabric<
  YMaps.YMapDefaultFeaturesLayer,
  YMapDefaultFeaturesLayerProps
>("YMapDefaultFeaturesLayer");

export type YMapDefaultSatelliteLayerProps = React.ComponentPropsWithoutRef<
  typeof YMapsReact.YMapDefaultSatelliteLayer
>;
export const YMapDefaultSatelliteLayer = YMapComponentFabric<
...
export const YMapControlButton = YMapComponentFabric<YMaps.YMapControlButton, YMapControlButtonProps>(
  "YMapControlButton",
);
...
export const YMapFeatureDataSource = YMapComponentFabric<YMaps.YMapFeatureDataSource, YMapFeatureDataSourceProps>(
